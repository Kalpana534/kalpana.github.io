		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <div class="row row-static-margin-bottom">
                    <div class="col-xs-5">
                        <label class="control-label" for="show-less-scroll-top"><?php _e('After "Show Less" scroll to initial possition', YRM_LANG);?>:</label>
                    </div>
                    <div class="col-xs-4">
                        <input type="checkbox" id="show-less-scroll-top" name="show-less-scroll-top" class="yrm-accordion-checkbox" <?php echo $showLessScrollTop;?>>
                    </div>
                </div>
			</div>
		</div>
